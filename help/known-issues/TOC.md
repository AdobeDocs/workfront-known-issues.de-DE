...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Aktuelle Probleme in [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Workfront-Planung: Fehler „Anfrage konnte nicht gesendet werden“](/help/known-issues/known-issues-workfront/wf-planning-error-fail-to-submit-request.md)
      + [Genehmigungen: Genehmigungen werden automatisch gesperrt](known-issues-workfront/wf-approvals-are-locked.md)
      + [Zuweisungen: Erweiterte Zuweisungsänderung kann nicht in einem Bericht gespeichert werden](known-issues-workfront/wf-assignments-cannot-save-advanced-from-report.md)
      + [Berichte: Workfront Planning-Felder werden nicht in Report Builder für Arbeitsflächen-Dashboards angezeigt](known-issues-workfront/wf-reporting-canvas-dashboards-no-planning.md)
      + [Benutzende: Direktberichte können nicht entfernt werden](known-issues-workfront/wf-users-cannot-remove-direct-reports.md)
      + [Anfragen: Ein Dokument kann beim Ausfüllen einer Anfrage nicht hochgeladen werden](known-issues-workfront/wf-request-cannot-submit-with-document.md)
      + [Anfragen: „Kein Betreff“ wird in der Anfrageliste angezeigt](known-issues-workfront/wf-requests-no-subject.md)
      + [Benutzerdefinierte Formulare: Die Anzeigelogik wird im Anfrageformular nicht korrekt angezeigt](known-issues-workfront/wf-custom-forms-display-logic-not-triggering.md)
      + [Anmeldung: Workfront wird nach der Anmeldung nicht geladen](known-issues-workfront/wf-login-wf-does-not-load.md)
      + [Lastenausgleich: Stunden pro Benutzer werden nicht korrekt berechnet](known-issues-workfront/wf-workload-balancer-hours-per-user-not-correct.md)
      + [Dokumente: Bedienfeld Zusammenfassung ist leer](known-issues-workfront/wf-documents-summary-panel-is-blank.md)
      ...
      + [Anfragen: Probleme mit Entwürfen im neuen Anfrageerlebnis](known-issues-workfront/wf-requests-issues-with-drafts.md)
      + [Anfragen: Anfrage-Warteschlangen werden mehrmals angezeigt](known-issues-workfront/wf-requests-queues-duplicated.md)
      ...
      + [Reporting: Benutzende sehen Finanzdaten in Visualisierungen des Arbeitsflächen-Dashboards](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Workfront-Planung: Feld kann nicht zu einer Ansicht hinzugefügt werden](known-issues-workfront/wf-planning-cannot-add-field.md)
      ...
      + [Benutzende: Fehler beim Öffnen der Seite „Benutzende“](known-issues-workfront/wf-users-cannot-open-user-tab.md)
      ...
      + [Korrekturabzüge: Änderungen des Korrekturabzugstatus werden verzögert](known-issues-workfront/wf-proof-status-sync-delayed.md)
      ...
      + [Benutzende: Benutzende, die die Massenbearbeitung verwenden, entfernen Ressourcen-Pools und direkte Berichte](known-issues-workfront/wf-users-bulk-editing-clears-resource-pools.md)
      + [Anfragen: Dokument kann nicht aus GDrive in Anfrage hochgeladen werden](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md)
      + [Aufgaben: Änderungen am Abschnitt „Arbeitsaufträge“ einer Aufgabe werden nicht gespeichert](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md)
      ...
      + [Anfragen: Berechtigungen werden beim Erstellen einer Anfrage nicht übernommen](known-issues-workfront/wf-requests-permissions-not-inherited.md)
      + [Zeitpläne: Berechtigungen für Zeitplan für eine Gruppe widerrufen](known-issues-workfront/wf-schedules-group-permissions-revoked.md)
      ...
      + [Arbeitszeittabellen: Arbeitszeittabellen nicht generiert](known-issues-workfront/wf-timesheets-not-generated.md)
      ...
      + [Genehmigungen: Für die Genehmigung wird „Keine Frist“ angezeigt, wenn in der Frist keine Uhrzeit enthalten ist](/help/known-issues/known-issues-workfront/wf-approvals-displays-no-deadline-if-no-time.md)
      ...
      + [Berechtigungen: Objektberechtigungen werden nicht korrekt übernommen](known-issues-workfront/wf-permissions-not-inherited-correctly.md)
      ...
      + [Workfront Fusion: Verbindungsfehler bei einem Szenario](/help/known-issues/known-issues-workfront/wf-fusion-scenario-connection-error.md)
      + [Korrekturabzüge: Es können keine Korrekturabzüge für Videos erstellt werden, die von AEM über Fusion verknüpft sind](/help/known-issues/known-issues-workfront/wf-proof-cannot-generate-aem-video.md)
      + [Benutzerdefinierte Formulare: Firmen fehlen im benutzerdefinierten Feld für automatische Vervollständigung](/help/known-issues/known-issues-workfront/wf-custom-forms-companies-missing-typeahead.md)
      ...
      + [Genehmigungen: Delegierte Genehmigungen werden für Beauftragte nicht angezeigt](known-issues-workfront/wf-approvals-delegation-not-working.md)
      + [Workfront: Änderungen des Datumsformats in der gesamten Anwendung](known-issues-workfront/wf-workfront-date-format-changing.md)
      + [Workfront: ZScaler-Einstellungen können die Leistung beeinträchtigen](known-issues-workfront//wf-workfront-zscaler.md)
      + [Benachrichtigungen: E-Mail-Benachrichtigungen für Aktualisierungen werden nicht gesendet](known-issues-workfront/wf-notifications-emails-for-updates-not-sending.md)
      ...
      + [Prioritäten: Gruppierungen verhindern das Sortieren und die Inline-Bearbeitung](known-issues-workfront/wf-home-priorities-grouping-limitations.md)
      ...
      + [Gruppen: Der Status einer gelöschten Gruppe wird erneut angezeigt](known-issues-workfront/wf-groups-deleted-status-reappears.md)
      ...
      + [Startseite: Startseite stürzt mit dem Fehler „Nicht genügend Arbeitsspeicher“ ab](known-issues-workfront/wf-home-crashes-with-error.md)
      ...
      + [Aufgaben: Bei der Suche nach dem Vornamen in der Aufgabenzuweisung werden keine Benutzenden zurückgegeben](known-issues-workfront/wf-tasks-cannot-assign-by-first-name.md)
      ...
      + [Startseite: Das Genehmigungs-Widget ist nicht korrekt](known-issues-workfront/wf-home-approvals-widget-not-up-to-date.md)
      ...
      + [Navigation: Schaltfläche „Zurück“ führt nicht zur vorherigen Seite zurück](known-issues-workfront/wf-navigation-back-button-not-work.md)
      ...
      + [[!UICONTROL Startseite]: Das Widget [!UICONTROL Erwähnungen] auf der neuen [!UICONTROL Startseite] ist nicht auf Nachrichten beschränkt, in denen die Benutzerin bzw. der Benutzer getaggt ist](known-issues-workfront/inactive/wf-home-mentions-widget-new-home.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Aktuelle Probleme in [!DNL Workfront Fusion] {#fusion-current}
      + [Workfront Fusion: Fehler wegen fehlendem Header in AWS-Modulen](known-issues-workfront-fusion/fusion-missing-header-aws.md)
