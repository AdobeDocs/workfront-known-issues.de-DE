...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Aktuelle Probleme in [!DNL Workfront Proof] {#proof-current}
      + [Testsendungen: Die Druckzusammenfassung zeigt nicht alle Seiten des Testversands an](known-issues-workfront-proof/proof-print-summary-not-showing-all-pages.md)
