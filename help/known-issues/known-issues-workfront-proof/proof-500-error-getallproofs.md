...
description: '"Wenn ein Benutzer auf die Aktion "getAllProofs"der API für Testsendungen zugreift, gibt der Workfront Proof-Server die Meldung "500 Interner Serverfehler"zurück.'
hidefromtoc: true
