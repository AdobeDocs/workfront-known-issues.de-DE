...
| **Anfrage** | **Letzte Änderung** |
| -------------------------------------------------------------------------------------------------- | ----------------- |
| [Timesheets: Fehler beim Hinzufügen von Kommentaren zu einem Timesheet](known-issues-workfront/wf-timesheets-permissions-error-when-adding-hours.md) | 29. September 2022 |
